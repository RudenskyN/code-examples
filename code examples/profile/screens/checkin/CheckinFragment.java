 ...
 */
@Layout(id = R.layout.fragment_checkin)
public class CheckinFragment extends BaseMainFragment implements CheckinView {
    @Nullable
    ...
    @Override
    public CheckinPresenterInterface getBasePresenter() {
